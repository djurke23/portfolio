...
const translations = {
    'sr-latin': {
        ...
        'info_degree_value': 'Master studije (čeka se odbrana rada)',
        ...
        'project8_desc': 'Ultimativni digitalni dnevnik vozila. Logujte gorivo, održavanje, troškove i putovanja — sve na jednom mestu.',
    ...
    'en': {
        ...
        'info_degree_value': "Master's Degree (Awaiting Thesis Defense)",
        ...
        'project8_desc': 'The ultimate digital vehicle logbook. Log fuel, maintenance, expenses, and trips — all in one place.',
        'project9_title': 'Monster Gym',
